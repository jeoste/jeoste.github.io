...
import { A as AstroError, L as LiveContentConfigError, h as AstroUserError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, i as renderUniqueStylesheet, j as renderScriptElement, k as createHeadAndContent, r as renderComponent } from './astro/server_DdaBn-83.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CSuHMcl3.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_GOOGLE_SITE_VERIFICATION": "your_google_site_verification_code_here", "PUBLIC_RECAPTCHA_SITE_KEY": "6LcLeoUrAAAAAJeks1ZOCrTlhLuFIUU0ewMT8Tbc", "SITE": "https://jeoste.github.io/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_JzAiB7gz.mjs').then(n => n._);
