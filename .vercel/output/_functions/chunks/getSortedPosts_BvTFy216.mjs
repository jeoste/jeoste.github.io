import { C as CONTENT_LAYER_TYPE, L as LIVE_CONTENT_TYPE, d as defineCollection } from './_astro_content_D-55IOiQ.mjs';
import 'js-yaml';
import 'smol-toml';
...
import './astro/server_DdaBn-83.mjs';
...
import { s as slugifyStr, p as postFilter } from './postFilter_CqXOWmtw.mjs';
...
defineCollection({
  ...
  schema: ({ image }) => z.object({
    ...
    ogImage: z.union([z.string(), image()]).optional(),
...
export { getPath as a, getSortedPosts as g };
